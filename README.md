...
| **Manager** | `Bose Thomas` | `Manager@123` | EMP002 - Bose Thomas | Approves/rejects leave applications for reporting subordinates (EMP001, EMP005, EMP006) |
| **Manager** | `Rahul Kumar` | `Manager@123` | EMP004 - Rahul  | Approves/rejects leave applications for reporting subordinates |
